    ...
    <ul>
      ...
      <li><b>Responsive Design</b>:
        <ul>
          ...
          <li>Utilized responsive images and backgrounds, with dimensions and versions tailored to ensure optimal visual experience across different screen sizes and pixel densities (<i><b>Retina display support<b></i).</li>
        </ul>
      </li>
    </ul>
  </li>
